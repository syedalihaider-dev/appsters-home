...
import styles from "./Conviced.module.css"
// Images 
                    ...
                    <Row>
                        ...
                        <Col lg={12}>
                            <Swiper
                                ...
                                className={styles.convicedSlider}
                            >
                                <SwiperSlide>
                                    <div className='px-2'>
                                        <div className={`${styles.cardNegative}`}>
                                            <div className={`${styles.card}`}>
                                                <div className="cardTop">
                                                    <p>As a long-time client of Appsters <span className={styles.blue}>mobile app development company</span>, I'm consistently impressed by their quality <span>cross-platform app development services</span> Their innovative approach has improved our businesses across the board.</p>
                                                </div>
                                                <div className={styles.cardBottom}>
                                                    ...
                                                    <div className="review d-flex align-items-center gap-2">
                                                        ...
                                                        <Image src="/newmobileapp/reviewImage.png" alt='Appsters' width={21} height={24} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <SwiperSlide>
                                    <div className='px-2'>
                                        <div className={`${styles.cardNegative}`}>
                                            <div className={` ${styles.card}`}>
                                                <div className="cardTop">
                                                    <p>Choosing Appsters for <span className={styles.green}>Android app development services</span> was the best decision we could’ve made. The custom app they developed not only met but exceeded my expectations, showcasing their expertise as a top software developer.</p>
                                                </div>
                                                <div className={styles.cardBottom}>
                                                    <div className="client d-flex align-items-center gap-1 gap-xxl-3">
                                                        {/* <Image src={Client1} alt='Appsters' width={45} height={45} /> */}
                                ...
                                <SwiperSlide>
                                    <div className='px-2'>
                                        <div className={styles.card}>
                                            <div className="cardTop">
                                                <p>I did extensive research to narrow down and determine the foremost <span className={styles.red}>mobile app development services in US,</span> by far Appsters stood out on all spectrums. My ROI has gone through the roof.</p>
                                            </div>
                                            <div className={styles.cardBottom}>
                                                <div className="client d-flex align-items-center gap-1 gap-xxl-3">
                                                    {/* <Image src={Client1} alt='Appsters' width={45} height={45} /> */}
                                ...
                                <SwiperSlide>
                                    <div className='px-2'>
                                        <div className={`${styles.cardNegative}`}>
                                            <div className={`${styles.card}`}>
                                                <div className="cardTop">
                                                    <p>I was in dire need of <span className={styles.green}>Flutter app development services, </span>a friend of mine told me about this company he had worked with. Appsters’ work was flawless, and my return on Investment far exceeded what I had hoped for.</p>
                                                </div>
                                                <div className={styles.cardBottom}>
                                                    <div className="client d-flex align-items-center gap-1 gap-xxl-3">
                                                        {/* <Image src={Client1} alt='Appsters' width={45} height={45} /> */}
                                ...
                                <SwiperSlide>
                                    <div className='px-2'>
                                        <div className={styles.card}>
                                            <div className="cardTop">
                                                <p>Exclusivity is the name of the game. I wanted immaculate <span className={styles.red}>Android app development services</span>. Appsters claimed they were a premier <span className={styles.red}>Android app development company</span> and they certainly lived up to their word.</p>
                                            </div>
                                            <div className={styles.cardBottom}>
                                                <div className="client d-flex align-items-center gap-1 gap-xxl-3">
                                                    {/* <Image src={Client1} alt='Appsters' width={45} height={45} /> */}
