            ...
            {cards.map((card, index) => (
                <div className={`${styles.card} ${index === activeIndex ? styles.active : ''}`}
                    ...
                    <div className={styles.imgBox}>
                        {index === 0 && <Image src="/newmobileapp/icon1.png" alt='Appsters' className='img-fluid' width={300} height={300} />}
                        {index === 1 && <Image src="/newmobileapp/icon2.png" alt='Appsters' className='img-fluid' width={300} height={300} />}
                        {index === 2 && <Image src="/newmobileapp/icon3.png" alt='Appsters' className='img-fluid' width={300} height={300} />}
                    </div>
                    <h3>{card.title}</h3>
                    <p>{card.content}</p>
                </div>
                        ...
                        <Slider {...deliverSlider} className='d-block d-md-none'>
                            <div>
                                <div className={`${styles.card}`}>
                                    <div className={styles.imgBox}>
                                        <Image src="/newmobileapp/icon1.png" alt='Appsters' className='img-fluid' width={300} height={300} /> 
                                    </div>
                            ...
                            <div>
                                <div className={`${styles.card}`}>
                                    <div className={styles.imgBox}>
                                        <Image src="/newmobileapp/icon2.png" alt='Appsters' className='img-fluid' width={300} height={300} />
                                    </div>
                            ...
                            <div>
                                <div className={`${styles.card}`}>
                                    <div className={styles.imgBox}>
                                        <Image src="/newmobileapp/icon3.png" alt='Appsters' className='img-fluid' width={300} height={300} />
                                    </div>
