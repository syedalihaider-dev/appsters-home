                            ...
                            <Col md={6} lg={4} className='p-2'>
                                <div className={`${styles.iosCard} ${styles.card}`}>
                                    <div className={styles.cardTop}>
                                        ...
                                        <Image src="/newmobileapp/ios.png" width={25} height={30} alt='Appsters' />
                                    </div>
                            ...
                            <Col md={6} lg={4} className='p-2'>
                                <div className={`${styles.andriodCard} ${styles.card}`}>
                                    <div className={styles.cardTop}>
                                        ...
                                        <Image src="/newmobileapp/andriod.png" width={25} height={30} alt='Appsters' />
                                    </div>
                                    <div className="cardContent">
                                        <p>
                            ...
                            <Col md={6} lg={4} className='p-2'>
                                <div className={`${styles.nativeCard} ${styles.card}`}>
                                    <div className={styles.cardTop}>
                                        ...
                                        <Image src="/newmobileapp/native.png" width={32} height={30} alt='Appsters' />
                                    </div>
                                    <div className="cardContent">
                                        <p>
                            ...
                            <Col md={6} lg={4} className='p-2'>
                                <div className={`${styles.flutterCard} ${styles.card}`}>
                                    <div className={styles.cardTop}>
                                        ...
                                        <Image src="/newmobileapp/flutter.png" width={25} height={30} alt='Appsters' />
                                    </div>
                                    <div className="cardContent">
                                        <p>
                            ...
                            <Col md={6} lg={4} className='p-2'>
                                <div className={`${styles.crossCard} ${styles.card}`}>
                                    <div className={styles.cardTop}>
                                        ...
                                        <Image src="/newmobileapp/cross.png" width={36} height={30} alt='Appsters' />
                                    </div>
                                    <div className="cardContent">
                                        <p>
                            ...
                            <Col md={6} lg={4} className='p-2'>
                                <div className={`${styles.webdevelopmentCard} ${styles.card}`}>
                                    <div className={styles.cardTop}>
                                        ...
                                        <Image src="/newmobileapp/webdevelopment.png" width={31} height={30} alt='Appsters' />
                                    </div>
                                    <div className="cardContent">
                                        <p>
