...
export default function DeliveredSolutions({ data = {} }) {
    const subHeading = data.subHeading || "Appsters Houston";
    const title = data.title || "Work with a Local Mobile App <br/> Developer in Houston";
    ...
    const defaultBoxes = [
        {
            ...
            para: "Find your trusted certified developers who understand coding standards, ensuring better performance while saving your time and money. We have been successful and popular among..",
        },
        {
            counter: "40",
                            ...
                            <div key={index} className="col-sm-12 col-md-4 col-lg-4">
                                <div className={index === 0 ? styles.sec_left : styles.sec_right}>
                                    <div className={styles.box}>
                                        ...
                                        <p className={`${styles.para} scroll_block`}>{box.para}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
