            ...
            <div className="container">
                <div className="row align-items-start">
                    <div className="col-sm-12 col-md-3">
                        <span className={styles.sub_heading}><span className={styles.bullet}></span>Appsters Houston</span>
                    </div>
                    <div className="col-sm-12 col-md-6">
                        <div className={styles.sec_left}>
                            <h2>
                                Work with a Local Mobile App <br/> Developer in Houston
                            </h2>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-3">
                        ...
                        <div className="col-sm-12 col-md-4 col-lg-4">
                            <div className={styles.sec_left}>
                                <div className={styles.box}>
                                    ...
                                    <p className={styles.counter}>100
                                    ...
                                    <h6 className={styles.heading}>Business Apps Developed</h6>
                        ...
                        <div className="col-sm-12 col-md-4 col-lg-4">
                            <div className={styles.sec_right}>
                                <div className={styles.box}>
                                    ...
                                    <h6 className={styles.heading}>Industries Catered</h6>
                                    <p className={`${styles.para} scroll_block`}>
                                        Find your trusted certified developers who understand coding standards, ensuring better performance while saving your time and money. We have been successful and popular among..
                                    </p>
                        ...
                        <div className="col-sm-12 col-md-4 col-lg-4">
                            <div className={styles.sec_right}>
                                <div className={styles.box}>
                                    ...
                                    <h6 className={styles.heading}>Years of Experienced Developers</h6>
                                    <p className={`${styles.para} scroll_block`}>
