...
export default function EndToEndAppDevSection() {
    ...
    <section className={styles.endToEndSection}>
      <div className="container">
        <div className={styles.header}>
          <h2>
            END-TO-END MOBILE APP DEVELOPMENT <br />
            BRIDGING <span className={styles.highlight}>THE DIGITAL GAP.</span>
          </h2>
          <p className={styles.desc}>
            Our service stack covers every major platform and framework, ensuring your business and disruptive ideas can move from concept to launch without friction and glitches. Our developers integrate modern frameworks, data layers, and security-first architecture.
          </p>
        </div>
