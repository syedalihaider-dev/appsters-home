        ...
        <section className={styles.ctaSection} id="contact">
            <div className="container">
                <div className={styles.contentWrapper}>
                    ...
                    <motion.div className={styles.infoColumn} {...staggerContainer(0.1)}>
                        ...
                        <motion.ul className={styles.featuresList} variants={staggerItem('up')}>
                            <li>
                    ...
                    {/* Right Column: Form */}
                    <motion.div className={styles.formColumn} {...reveal('right', 0.1)}>
                        <div className={styles.formCard}>
                            <form className={styles.form} onSubmit={handleSubmit}>
                                <div className={styles.formGroup}>
                                    <label htmlFor="cta-name">NAME <span className={styles.asterisk}>*</span></label>
                                    <input type="text" id="cta-name" name="name" value={formData.name} onChange={handleChange} placeholder="Jordan Rivera" required />
                                </div>

                                <div className={styles.formGroup}>
                                    <label htmlFor="cta-email">EMAIL <span className={styles.asterisk}>*</span></label>
                                    <input type="email" id="cta-email" name="email" value={formData.email} onChange={handleChange} placeholder="jordan@company.com" required />
                                </div>

                                <div className={styles.formGroup}>
                                    <label htmlFor="cta-idea">YOUR APP IDEA <span className={styles.asterisk}>*</span></label>
                                    <textarea id="cta-idea" name="idea" rows="4" value={formData.idea} onChange={handleChange} placeholder="What do you want to build, and who is it for?" required></textarea>
                                </div>

                                <div className={styles.formGroup}>
                                    <label htmlFor="cta-budget">BUDGET RANGE <span className={styles.asterisk}>*</span></label>
                                    <div className={styles.selectWrapper}>
                                        <select id="cta-budget" name="budget" value={formData.budget} onChange={handleChange} required>
