...
const WhyAppstersSection = () => {
    ...
    return (
        <section className={styles.whyAppstersSection} id="whyus">
            <div className="container">
                <motion.div className={styles.header} {...staggerContainer(0.1)}>
                    ...
                    <motion.h2 className={styles.title} variants={staggerItem('up')}>
                        Five reasons teams <span className={styles.glowTextPurple}>stop Googling</span> and start building.
                    </motion.h2>
                </motion.div>

                <motion.div className={styles.cardsGrid} {...staggerContainer(0.1, 0.05)}>
                    {features.map((feature, index) => (
                        <motion.div className={styles.featureCard} key={index} variants={staggerItem('up', 36)}>
