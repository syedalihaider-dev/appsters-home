...
export async function POST(req) {
    try {
        ...
        const { name, email, phone, service, budget, timeline, description, pageUrl, countryCode } = body;
        ...
        const mailOptions = {
            ...
            subject: `New LP Lead: Mobile App Developers`,
            html: `
                <h3>New Lead Details (Mobile App Developers LP):</h3>
